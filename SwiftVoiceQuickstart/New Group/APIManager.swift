...
class APIManager: NSObject {
    ...
    class func loadApiRequest<T: Codable>(model: T.Type, urlPath: String, method: RequestMethod, params: [String : Any?]?, headers: [String: String]?, onCompletion: @escaping(T?, String?) -> ()) {
        
        Connector.shared.execute(urlPath, method, params, headers: headers) { (responseHTTP, error) in
